...
4. Створив нову гілку NewBranch1 за допомогою команди __git branch NewBranch1__ та перейшов на неї командою __git checkout__. Закомітив нові зміни у файлі README.md 
...
7. У Web версії GitHub вніс зміни та зберіг файл. Перейшов на локальну версію файлу на моєму ПК. Змін в ньому немає. Щоб зміни з'явилися в локальній версії, треба виконати команду __git pull__.
8. Закомітив зображення до репозиторію
![alt text](https://github.com/RSosnovskyi/Rostyslav-IT22/blob/master/lab1/5de24294bad21ec99931f4c362354f22.jpg)
